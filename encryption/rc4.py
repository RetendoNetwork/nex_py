...
class RC4:
    """
    RC4 encrypts data with RC4. Each instance maintains separate streams for encryption and decryption.
    """

    def __init__(self, key: Optional[bytes] = None):
        """
        Initializes a new instance of RC4 encryption with an optional key.
        """
        self.key = key or b""
        self.cipher = None
        self.decipher = None
    ...
    def get_key(self) -> bytes:
        ...
        :return: The current key as bytes.
        """
        return self.key
    ...
    def encrypt(self, payload: bytes) -> bytes:
        """
        Encrypts the payload with the outgoing RC4 stream.
    ...
    def decrypt(self, payload: bytes) -> bytes:
        """
        Decrypts the payload with the incoming RC4 stream.
    ...
    def copy(self) -> 'RC4':
        ...
        :return: A new RC4 instance with the same state.
        """
        copied = RC4(self.key)
